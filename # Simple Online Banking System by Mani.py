...
def admin_login():
    ...
    admin_pass = getpass.getpass("> Enter your Password: ")
...
# Simple Online Banking System by Manipreetham
...
def customer_login():
    ...
    customer_pass = getpass.getpass("> Enter your Password: ")
    customer_file = open("customer_db.txt","r")
    for line in customer_file:
...
def customer_deposit():
    ...
    deposit_pass = getpass.getpass("> Enter your Password: ")
    customer_file = open("customer_db.txt","r")
    transaction_file = open("transaction_db.txt","a")
    for line in customer_file:
...
def customer_withdraw():
    ...
    withdrawal_pass = getpass.getpass("> Enter your Password: ")
    customer_file = open("customer_db.txt","r")
    transaction_file = open("transaction_db.txt","a")
    for line in customer_file:
